                ...
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="px-3 py-1.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F4323D] text-sm bg-white"
                            >
                    ...
                    <div className="flex gap-3">
                        <Button
                            onClick={handlePrint}
                            variant="outline"
                            className="px-4 py-2 border-gray-300 text-gray-700 hover:bg-gray-50 flex items-center gap-2"
                        >
                        ...
                        <Button
                            ...
                            className="px-4 py-2 bg-[#F4323D] hover:bg-[#d62d37] text-white flex items-center gap-2"
                        >
            ...
            <div className="p-6 print:p-0">
                <div className="max-w-4xl mx-auto bg-white shadow-lg print:shadow-none">
                    ...
                    <div className="border-b-4 border-[#F4323D] p-10 print:p-12">
                        <div className="flex items-start justify-between mb-8">
                            <div className="flex items-start gap-4">
                                {/* Logo Placeholder */}
                                <div className="w-16 h-16 bg-[#F4323D] rounded-lg flex items-center justify-center text-white">
                                    <FileText className="w-8 h-8" />
                                </div>
                                <div>
                                    <h1 className="text-2xl mb-2 text-gray-900 font-bold">One Suite Advisory Pte Ltd</h1>
                            ...
                            <div className="text-right">
                                <div className="inline-block bg-[#F4323D] text-white px-6 py-3 rounded-lg">
                                    <p className="text-lg uppercase tracking-wider font-bold">Payslip</p>
                                </div>
                    ...
                    <div className="px-10 py-6 print:px-12 print:py-6 bg-gray-100 border-b-2 border-gray-300">
                        <div className="flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-3xl text-gray-900 font-bold">{payslipData.payPeriod}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-10 print:p-12">
                        <h2 className="text-sm uppercase tracking-wider text-gray-500 mb-6 pb-2 border-b-2 border-gray-300 font-bold">
                            Consultant Information
                        </h2>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center py-3 border-b border-gray-200">
                                ...
                                <p className="text-base text-gray-900 tabular-nums font-medium">
                                    S$ {payslipData.breakdown.baseCommission.toFixed(2)}
                                </p>
                            </div>
                            ...
                            <div className="flex justify-between items-center py-3 border-b border-gray-200">
                                ...
                                <p className="text-base text-gray-900 tabular-nums font-medium">
                                    S$ {payslipData.breakdown.overridingCommission.toFixed(2)}
                                </p>
                            </div>
                            ...
                            <div className="flex justify-between items-center py-3 border-b border-gray-200">
                                ...
                                <p className="text-base text-gray-900 tabular-nums font-medium">
                                    S$ {payslipData.breakdown.claims.toFixed(2)}
                                </p>
                            </div>
                            ...
                            <div className="flex justify-between items-center py-5 border-t-4 border-[#F4323D] mt-6">
                                ...
                                <p className="text-3xl text-[#F4323D] tabular-nums font-bold">
                                    S$ {totalIncomePayable.toFixed(2)}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-10 bg-green-50 border-2 border-green-200 rounded-lg p-5 flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-green-700">
                                    Payment of <strong>S$ {totalIncomePayable.toFixed(2)}</strong> has been successfully transferred to your registered bank account on <strong>{payslipData.payDate}</strong>.
                                </p>
                            </div>
                        </div>
